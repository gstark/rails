  ...
  module ModelSchema
    ...
    module ClassMethods
      ...
      def reset_column_information
        puts "COLUMN - #{name} - reset_column_information #{caller.join(" ")}"
      ...
      def load_schema
        ...
        @load_schema_monitor.synchronize do
          ...
          @schema_loaded = true
          puts "GES: load_schema done for #{name} #{@slug} #{caller.join(' ')}"
        end
      end
      ...
      def reload_schema_from_cache
        ...
        puts "GES: COLUMN: reload_schema_from_cache for #{name} #{@slug} #{caller.join(' ')}"
      end
